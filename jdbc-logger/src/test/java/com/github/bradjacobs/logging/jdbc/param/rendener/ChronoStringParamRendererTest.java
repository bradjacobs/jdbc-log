...
public class ChronoStringParamRendererTest extends AbstractParamRendererTest
{
    ...
    {
        ChronoStringParamRenderer renderer = new ChronoStringParamRenderer(TIMESTAMP_PATTERN, UTC_ZONE);
        assertEquals( createRenderedString(renderer, TEST_DATE), EXPECTED_DATETIME_UTC, "mismatch expected date string");
    }
    ...
    {
        ChronoStringParamRenderer renderer = new ChronoStringParamRenderer(TIMESTAMP_PATTERN, null);
        assertEquals( createRenderedString(renderer, TEST_DATE), EXPECTED_DATETIME_UTC, "mismatch expected date string");
    }
    ...
    {
        ChronoStringParamRenderer renderer = new ChronoStringParamRenderer(TIMESTAMP_PATTERN, PACITIC_ZONE);
        assertEquals( createRenderedString(renderer, TEST_DATE), EXPECTED_DATETIME_PACIFIC, "mismatch expected date string");
    }
    ...
    public void testDateStringRendererSqlTimestamp() throws Exception
    {
        ...
        ChronoStringParamRenderer renderer = new ChronoStringParamRenderer(TIMESTAMP_PATTERN, UTC_ZONE);
        assertEquals( createRenderedString(renderer, sqlTimestamp), EXPECTED_DATETIME_UTC, "mismatch expected date string");
    }
    ...
    public void testDateStringRendererSqlTimestampWithZone() throws Exception
    {
        java.sql.Timestamp sqlTimestamp = new java.sql.Timestamp(TEST_DATE_LONG);
        ChronoStringParamRenderer renderer = new ChronoStringParamRenderer(TIMESTAMP_PATTERN, PACITIC_ZONE);
        assertEquals( createRenderedString(renderer, sqlTimestamp), EXPECTED_DATETIME_PACIFIC, "mismatch expected date string");
    }
    ...
    public void testDateStringRendererSqlDate() throws Exception
    {
        ...
        ChronoStringParamRenderer renderer = new ChronoStringParamRenderer(DATE_PATTERN, UTC_ZONE);
        assertEquals( createRenderedString(renderer, sqlDate), EXPECTED_DATE_UTC, "mismatch expected date string");
    }
    ...
    {
        java.sql.Date sqlDate = new java.sql.Date(TEST_DATE_LONG);
        ChronoStringParamRenderer renderer = new ChronoStringParamRenderer(DATE_PATTERN, PACITIC_ZONE);
        assertEquals( createRenderedString(renderer, sqlDate), EXPECTED_DATE_PACIFIC, "mismatch expected date string");
    }
    ...
    public void testDateStringRendererSqlTime() throws Exception
    {
        ...
        ChronoStringParamRenderer renderer = new ChronoStringParamRenderer(TIME_PATTERN, UTC_ZONE);
        assertEquals( createRenderedString(renderer, sqlTime), EXPECTED_TIME_UTC, "mismatch expected date string");
    }
    ...
    {
        java.sql.Time sqlTime = new java.sql.Time(TEST_DATE_LONG);
        ChronoStringParamRenderer renderer = new ChronoStringParamRenderer(TIME_PATTERN, PACITIC_ZONE);
        assertEquals( createRenderedString(renderer, sqlTime), EXPECTED_TIME_PACIFIC, "mismatch expected date string");
    }
    ...
    {
        ChronoStringParamRenderer renderer = new ChronoStringParamRenderer("", UTC_ZONE);
    }
    ...
    {
        ChronoStringParamRenderer renderer = new ChronoStringParamRenderer(null, UTC_ZONE);
    }
    ...
    {
        ChronoStringParamRenderer renderer = new ChronoStringParamRenderer("yyyy_BOGUS_", UTC_ZONE);
    }
